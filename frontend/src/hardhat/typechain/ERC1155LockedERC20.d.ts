...
interface ERC1155LockedERC20Interface extends ethers.utils.Interface {
  functions: {
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "borrowERC20(address,uint256,address,address,bytes)": FunctionFragment;
    "decimals(uint256)": FunctionFragment;
    "isApprovedForAll(address,address)": FunctionFragment;
    "name(uint256)": FunctionFragment;
    "returnToERC20(address,uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "returnToERC20",
...
export class ERC1155LockedERC20 extends Contract {
  ...
  interface: ERC1155LockedERC20Interface;
