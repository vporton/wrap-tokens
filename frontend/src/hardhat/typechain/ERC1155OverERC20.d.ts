...
interface ERC1155OverERC20Interface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155OverERC20 extends Contract {
  ...
  interface: ERC1155OverERC20Interface;
